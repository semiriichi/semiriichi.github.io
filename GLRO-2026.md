...
**Instructions:**  Google form will be added here when registration opens! The Venmo tag for entry fee payment is included in the form. 
...
- Red Fives (Mod 2.1)
- 30/10 Uma (Mod 4.1)
- Lower Penalties (Mod 6.3), with the following modifications
  - Chombo -30 
